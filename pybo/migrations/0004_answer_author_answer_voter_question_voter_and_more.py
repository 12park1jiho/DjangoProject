# Generated by Django 4.2.17 on 2025-01-27 09:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('pybo', '0003_answer_modify_date_question_modify_date_and_more'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='answer',
            name='author',
            field=models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='author_answer', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='answer',
            name='voter',
